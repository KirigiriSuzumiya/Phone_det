...
import os
model = pdx.load_model(r'C:\Users\boyif\Desktop\paddle\Phone_det\output\FasterRCNN\best_model')  # 加载训练好的模型
...
eval_dataset = pdx.datasets.VOCDetection(
    ...
    file_list=r'C:\Users\boyif\Desktop\paddle\Phone_det\train\0_phone\test_list.txt',
